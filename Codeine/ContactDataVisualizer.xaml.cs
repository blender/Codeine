...
namespace Codeine
{
    ...
    public partial class ContactDataVisualizer 
    {
        ...
        private ContacDataController sharedController;
        ...
        private void OnContactDown(object sender, ContactEventArgs args)
        {
            ...
            sharedController.addContact(args.Contact, DiagramContainerGrid); 
        ...
        {
            UpdateDiagram(args.Contact);
            sharedController.updateContact(args.Contact, DiagramContainerGrid);
        }
        ...
        private void OnLostContactCapture(object sender, ContactEventArgs args)
        {
            ...
            sharedController.removeContact(args.Contact);
            UpdateStatistics();
        }
